...
import (
	...
	"github.com/speakeasy-sdks/test-go/pkg/models/sdkerrors"
	"github.com/speakeasy-sdks/test-go/pkg/models/shared"
	"github.com/speakeasy-sdks/test-go/pkg/utils"
	"io"
	"net/http"
	"strings"
	"time"
...
func New(opts ...SDKOption) *AcmeGo {
	sdk := &AcmeGo{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "1.6.0",
			GenVersion:        "2.169.0",
			UserAgent:         "speakeasy-sdk/go 1.6.0 2.169.0 0.1.0 github.com/speakeasy-sdks/test-go",
		},
	}
