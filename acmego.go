...
import (
	...
	"context"
	"fmt"
	"github.com/speakeasy-sdks/test-go/v3/internal/hooks"
...
func New(opts ...SDKOption) *AcmeGo {
	sdk := &AcmeGo{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "3.1.1",
			GenVersion:        "2.263.3",
			UserAgent:         "speakeasy-sdk/go 3.1.1 2.263.3 0.1.0 github.com/speakeasy-sdks/test-go",
			Hooks:             hooks.New(),
		},
	}
...
func (s *AcmeGo) CreateUserv1(ctx context.Context, request shared.UserInput) (*operations.CreateUserv1Response, error) {
	hookCtx := hooks.HookContext{OperationID: "createUserv1"}
...
func (s *AcmeGo) DeleteUserv1(ctx context.Context, request operations.DeleteUserv1Request) (*operations.DeleteUserv1Response, error) {
	hookCtx := hooks.HookContext{OperationID: "deleteUserv1"}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/user/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *AcmeGo) GetHealth(ctx context.Context) (*operations.GetHealthResponse, error) {
	hookCtx := hooks.HookContext{OperationID: "getHealth"}
...
func (s *AcmeGo) GetUserv1(ctx context.Context, request operations.GetUserv1Request) (*operations.GetUserv1Response, error) {
	hookCtx := hooks.HookContext{OperationID: "getUserv1"}
...
func (s *AcmeGo) SearchUsersv1(ctx context.Context, request shared.Filters) (*operations.SearchUsersv1Response, error) {
	hookCtx := hooks.HookContext{OperationID: "searchUsersv1"}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := url.JoinPath(baseURL, "/v1/users/search")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *AcmeGo) UpdateUserv1(ctx context.Context, request operations.UpdateUserv1Request) (*operations.UpdateUserv1Response, error) {
	hookCtx := hooks.HookContext{OperationID: "updateUserv1"}
